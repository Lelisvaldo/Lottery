        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <hr class="star-dark mb-5">
                    <img class="img-fluid mb-5" src="{{URL::asset($sorteios[0]->foto_sorteio)}}" alt="{{$sorteios[0]->titulo_sorteio}}">
                    <p class="mb-3">Detalhes<br>{{$sorteios[0]->descricao_sorteio}}</p>
                    <p class="mb-3">Premio<br>{{$sorteios[0]->brinde_sorteio}}</p>
                    <p class="mb-4">Periodo de Inscrição<br><b>{{date( 'd/m/Y' , strtotime($sorteios[0]->data_inicio))}}</b>&nbsp;-&nbsp;<b>{{date( 'd/m/Y' , strtotime($sorteios[0]->data_fim))}}</b></p>
